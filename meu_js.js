...
$('.target').on('change', function () {
    ...
    let data2 = getMunicipios("https://servicodados.ibge.gov.br/api/v1/localidades/estados/" + selectedestado + "/municipios");
...
function main() {
    let data = getEstados("https://servicodados.ibge.gov.br/api/v1/localidades/estados");
